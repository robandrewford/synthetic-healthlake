...
-- Create Schemas
CREATE SCHEMA IF NOT EXISTS RAW COMMENT
= 'Landing area for raw JSON data from S3';
CREATE SCHEMA IF NOT EXISTS ANALYTICS COMMENT
= 'Modeled data transformed by dbt';
