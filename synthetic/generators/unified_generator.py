...
class UnifiedGenerator:
    ...
    def generate_person(self, person_id: int) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        if self.fake.boolean(chance_of_getting_true=10):
            deceased_date = self.fake.date_time_between(
    ...
    def generate_conditions(self, person_id: int, count: int = None) -> List[Dict[str, Any]]:
        ...
        selected_conditions = random.sample(self.condition_concepts, min(count, len(self.condition_concepts)))
        
        for i, (concept_id, name) in enumerate(selected_conditions):
    ...
    def generate_measurements(self, person_id: int, count: int = None) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            concept_id, name, min_val, max_val, unit_concept_id = random.choice(self.measurement_concepts)
