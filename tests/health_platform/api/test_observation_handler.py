...
class TestObservationHandler:
    ...
    def test_search_observations_by_single_code(self, mock_query):
        ...
        mock_query.side_effect = [
            ...
            [
                {
                    "RECORD_CONTENT": json.dumps(
                        {"id": "obs-1", "code": {"coding": [{"code": "2339-0"}]}}
                    )
                },
                {
                    "RECORD_CONTENT": json.dumps(
                        {"id": "obs-2", "code": {"coding": [{"code": "2339-0"}]}}
                    )
                },
            ],
        ]

        event = {"pathParameters": None, "queryStringParameters": {"code": "2339-0"}}
        response = lambda_handler(event, {})
    ...
    def test_search_observations_by_multiple_codes(self, mock_query):
        ...
        mock_query.side_effect = [
            ...
            [
                ...
                {
                    "RECORD_CONTENT": json.dumps(
                        {"id": "obs-2", "code": {"coding": [{"code": "8867-4"}]}}
                    )
                },
                {
                    "RECORD_CONTENT": json.dumps(
                        {"id": "obs-3", "code": {"coding": [{"code": "2339-0"}]}}
                    )
                },
            ],
        ]
    ...
    def test_search_observations_by_date(self, mock_query):
        ...
        mock_query.side_effect = [
            ...
            [
                {
                    "RECORD_CONTENT": json.dumps(
                        {"id": "obs-1", "effectiveDateTime": "2024-01-15T10:30:00Z"}
                    )
                }
            ],
        ]
    ...
    def test_search_observations_by_status(self, mock_query):
        ...
        event = {"pathParameters": None, "queryStringParameters": {"status": "final"}}
        response = lambda_handler(event, {})
    ...
    def test_search_observations_invalid_pagination(self, mock_query):
        ...
        event = {"pathParameters": None, "queryStringParameters": {"_count": "abc"}}
        response = lambda_handler(event, {})
